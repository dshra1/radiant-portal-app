...
function Page() {
  return (
    <div className="m3">
<aside className="fixed left-0 top-0 h-full w-64 bg-inverse-surface z-50 flex flex-col justify-between select-none shadow-[0_1px_8px_rgba(0,0,0,0.08)]"><div className="flex flex-col flex-1 overflow-y-auto"><div className="h-14 flex items-center px-space-base gap-space-sm bg-inverse-surface"><img alt="Modern geometric architectural logo mark for 'Saha OS' / 'SAHA Developers'. A minimalist stylized double chevron or structured building block tower forming an abstract 'S' in vibrant emerald green (#10B981) and steel navy blue (#0F172A), sharp vector graphics, clean construction tech branding.. Design context: - Primary color: #059669\n- Font: inter\n- Mode: light\n- Roundness: rounded-sm\n. The logo should be visually consistent with these brand tokens." className="h-8 w-auto object-contain" src="https://lh3.googleusercontent.com/aida/AEtjO1WQvHv-w-7YzvmAoSygpbOwBk1iQYVQQ65a2DVy0Fd1zI5jhbBBBVh1JD6aqCDJ7orLfl63MPTtWb96XXK_1l_Dzq_aPWlZZ1y96SIjDxs8Nz14hP3lsjzU-A_wsfrlOuv2KIK5oj9SqaLbs-dxD_UgTbThCma7YzfTSt9WPQ6_aUFJyt81rg0GxEzmounaHcNF9aGTWEKR6R7I_K8n-N_U3d-qPiiu26hQgRU3D99VNPmFjt4" /><div className="flex flex-col"><span className="font-headline-sm text-headline-sm text-inverse-on-surface tracking-tight leading-none">Saha OS</span><span className="font-label-sm text-label-sm text-secondary-fixed-dim uppercase tracking-wider mt-space-2xs">SAHA DEVELOPERS</span></div></div><div className="px-space-md py-space-sm mx-space-sm my-space-xs bg-inverse-surface rounded-xl flex flex-col gap-space-2xs"><div className="flex items-center justify-between"><span className="font-label-sm text-label-sm text-secondary-fixed-dim uppercase tracking-wider">Active Project</span><span className="w-2 h-2 rounded-full bg-primary-fixed animate-pulse"></span></div><div className="font-title-md text-title-md text-inverse-on-surface truncate">Cyber Enclave - Phase 2</div><div className="flex items-center gap-space-xs text-secondary-fixed-dim"><span className="material-symbols-outlined text-[14px]">location_on</span><span className="font-body-sm text-body-sm truncate">Madhapur, Hyderabad</span></div></div><nav className="flex flex-col px-space-sm py-space-xs gap-space-2xs" data-active-classes="bg-primary-container text-on-primary-container font-semibold rounded-lg shadow-sm"><div className="px-space-sm pt-space-md pb-space-2xs"><span className="font-label-sm text-label-sm text-secondary-fixed-dim uppercase tracking-widest">Lifecycle Core</span></div><a className="flex items-center gap-space-sm px-space-md py-space-sm rounded-lg text-secondary-fixed-dim hover:bg-inverse-surface hover:text-inverse-on-surface transition-colors" data-path="projects-and-setup" href="#"><span className="material-symbols-outlined text-[18px]">domain</span><span className="font-body-sm text-body-sm">Projects &amp; Setup</span></a><a className="flex items-center gap-space-sm px-space-md py-space-sm rounded-lg text-secondary-fixed-dim hover:bg-inverse-surface hover:text-inverse-on-surface transition-colors" data-path="boq-engine" href="/boq-engine"><span className="material-symbols-outlined text-[18px]">receipt_long</span><span className="font-body-sm text-body-sm">BOQ Engine</span></a><a className="flex items-center gap-space-sm px-space-md py-space-sm rounded-lg text-secondary-fixed-dim hover:bg-inverse-surface hover:text-inverse-on-surface transition-colors" data-path="stage-wise-planning-hub" href="#"><span className="material-symbols-outlined text-[18px]">account_tree</span><span className="font-body-sm text-body-sm">Stage-Wise Planning</span></a><div className="px-space-sm pt-space-md pb-space-2xs"><span className="font-label-sm text-label-sm text-secondary-fixed-dim uppercase tracking-widest">Site &amp; Operations</span></div><a className="flex items-center gap-space-sm px-space-md py-space-sm rounded-lg text-secondary-fixed-dim hover:bg-inverse-surface hover:text-inverse-on-surface transition-colors" data-path="site-execution-and-pour-cards" href="#"><span className="material-symbols-outlined text-[18px]">foundation</span><span className="font-body-sm text-body-sm">Pour Cards &amp; Execution</span></a><a className="flex items-center gap-space-sm px-space-md py-space-sm rounded-lg text-secondary-fixed-dim hover:bg-inverse-surface hover:text-inverse-on-surface transition-colors" data-path="procurement-and-inventory" href="#"><span className="material-symbols-outlined text-[18px]">inventory_2</span><span className="font-body-sm text-body-sm">Procurement &amp; Stock</span></a><div className="px-space-sm pt-space-md pb-space-2xs"><span className="font-label-sm text-label-sm text-secondary-fixed-dim uppercase tracking-widest">Governance</span></div><a className="flex items-center gap-space-sm px-space-md py-space-sm rounded-lg text-secondary-fixed-dim hover:bg-inverse-surface hover:text-inverse-on-surface transition-colors" data-path="reports-and-audits" href="#"><span className="material-symbols-outlined text-[18px]">verified</span><span className="font-body-sm text-body-sm">Reports &amp; Audits</span></a><div className="px-space-sm pt-space-md pb-space-2xs font-label-sm text-label-sm uppercase tracking-wider text-outline-variant">All Screens</div><a className="flex items-center px-space-sm py-space-sm rounded text-inverse-on-surface hover:bg-surface-variant hover:text-on-surface transition-colors font-body-md text-body-md" href="/boq-upload">BOQ Excel Upload</a><a className="flex items-center px-space-sm py-space-sm rounded text-inverse-on-surface hover:bg-surface-variant hover:text-on-surface transition-colors font-body-md text-body-md" href="/site-execution">Site Execution</a><a className="flex items-center px-space-sm py-space-sm rounded text-inverse-on-surface hover:bg-surface-variant hover:text-on-surface transition-colors font-body-md text-body-md" href="/qa-inspection">AI Visual QA/QC Inspection</a><a className="flex items-center px-space-sm py-space-sm rounded text-inverse-on-surface hover:bg-surface-variant hover:text-on-surface transition-colors font-body-md text-body-md" href="/execution-manual">Stage-Wise Field Execution Manual</a><a className="flex items-center px-space-sm py-space-sm rounded text-inverse-on-surface hover:bg-surface-variant hover:text-on-surface transition-colors font-body-md text-body-md" href="/site-media">Site Media</a><a className="flex items-center px-space-sm py-space-sm rounded text-inverse-on-surface hover:bg-surface-variant hover:text-on-surface transition-colors font-body-md text-body-md" href="/po-create">Smart Purchase Order Creation Engine</a><a className="flex items-center px-space-sm py-space-sm rounded text-inverse-on-surface hover:bg-surface-variant hover:text-on-surface transition-colors font-body-md text-body-md" href="/projects-setup">Project Setup</a><a className="flex items-center px-space-sm py-space-sm rounded text-inverse-on-surface hover:bg-surface-variant hover:text-on-surface transition-colors font-body-md text-body-md" href="/boq-engine">BOQ Master Engine</a><a className="flex items-center px-space-sm py-space-sm rounded text-inverse-on-surface hover:bg-surface-variant hover:text-on-surface transition-colors font-body-md text-body-md" href="/price-intelligence">Real-Time Multi-Brand Price Intelligence</a><a className="flex items-center px-space-sm py-space-sm rounded text-inverse-on-surface hover:bg-surface-variant hover:text-on-surface transition-colors font-body-md text-body-md" href="/brand-benchmark">Multi-Brand Equivalency</a><a className="flex items-center px-space-sm py-space-sm rounded text-inverse-on-surface hover:bg-surface-variant hover:text-on-surface transition-colors font-body-md text-body-md" href="/purchase-orders">Smart Purchase Order</a><a className="flex items-center px-space-sm py-space-sm rounded text-inverse-on-surface hover:bg-surface-variant hover:text-on-surface transition-colors font-body-md text-body-md" href="/tender-comparison">Multi-Vendor Tender Quotation Comparison</a></nav></div><div className="p-space-sm mx-space-sm mb-space-sm bg-inverse-surface rounded-xl flex items-center justify-between"><div className="flex items-center gap-space-xs"><span className="w-2 h-2 rounded-full bg-primary-fixed"></span><span className="font-label-sm text-label-sm text-secondary-fixed-dim">Telemetry Sync: Real-time</span></div><span className="font-label-sm text-label-sm text-primary-fixed">v3.4.1</span></div></aside><div className="pl-64"><header className="fixed top-0 left-64 right-0 h-14 bg-surface/90 backdrop-blur-xl z-40 flex items-center justify-between px-gutter-normal shadow-[0_1px_8px_rgba(0,0,0,0.04)]"><div className="flex items-center gap-space-md w-96"><div className="relative w-full flex items-center"><span className="material-symbols-outlined absolute left-space-sm text-outline pointer-events-none text-[18px]">search</span><input className="w-full pl-9 pr-space-md py-space-xs bg-surface-container-low text-on-surface font-body-sm text-body-sm rounded-lg placeholder:text-outline focus:outline-none focus:bg-surface-container-lowest transition-colors" placeholder="Search pour cards, drawing codes, or assets..." type="text" /></div></div><div className="flex items-center gap-space-lg"><div className="hidden md:flex items-center gap-space-xs px-space-md py-space-xs bg-surface-container rounded-full text-on-surface"><span className="material-symbols-outlined text-primary text-[18px]">wb_sunny</span><div className="flex items-center gap-space-xs"><span className="font-tabular-metric-sm text-tabular-metric-sm">31°C</span><span className="font-body-sm text-body-sm text-on-surface-variant">Clear, Madhapur</span></div></div><div className="flex items-center gap-space-sm"><button aria-label="Notifications" className="relative p-space-xs rounded-lg text-on-surface-variant hover:bg-surface-container hover:text-on-surface transition-colors" type="button"><span className="material-symbols-outlined text-[20px]">notifications</span><span className="absolute top-1 right-1 w-2 h-2 bg-error rounded-full"></span></button><button aria-label="Help & Documentation" className="p-space-xs rounded-lg text-on-surface-variant hover:bg-surface-container hover:text-on-surface transition-colors" type="button"><span className="material-symbols-outlined text-[20px]">help</span></button></div><div className="flex items-center gap-space-sm pl-space-sm"><div className="flex flex-col text-right hidden sm:flex"><span className="font-title-md text-title-md text-on-surface leading-tight">Vikram Reddy</span><span className="font-label-sm text-label-sm text-on-surface-variant">Chief Project Engineer</span></div><img alt="Profile" className="w-8 h-8 rounded-full object-cover" src="https://lh3.googleusercontent.com/aida/AEtjO1Xoa18FO6wLBPTZ7sNX_7JLfyIK-rfPx2FXR01usuQoQJmhbOx9TkJLaoCv92ZIoLDWGfwWJfd2m2w6pCDPr1VnR4lMre0Ggs78rftYRxbvqvBUlK16MeCQqRdmoML_OJwsQ2WNO_Iyk3KSNM15noyNFnDoRAadsVT9-d-jwAUoevtTHLW1D6kJjXGvpoAOUQ-kdJXvjRRLysi7J1JnVF80j2FfBHnw3kPrGsvE6LV-mXVyIjkCwCcXjQ" /></div></div></header><main className="w-full pt-14 px-gutter-normal pb-gutter-expanded bg-surface"><div className="flex flex-col w-full gap-space-lg">
