...
export const SAMPLE_DATA_ROUTES: Record<string, string> = {
  ...
  "/purchasing-center": "purchase requests and order values",: "mandi / market rate feeds",
  "/brand-benchmark": "brand comparison rates",: "tender bids and comparisons",
  ...
  "/bills-payments": "bill and payment records",: "vendor scores and lifecycle stages",
